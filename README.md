...
Zooming is done via the mouse wheel or via a pinch gesture. Gesture recognition uses the browser's native Pointer Events — no extra dependency is required.
